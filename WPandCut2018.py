...
CAMPAIGN='Autumn18_102X_nAODv7_Full2018v7_HWW'
STEP="MCl1loose2018v7__MCCorr2018v7__HMSemilepSKIMv7_1__HMFull_V13_jhchoi_nom"

CAMPAIGN_DATA='Run2018_102X_nAODv7_Full2018v7'
STEP_DATA="DATAl1loose2018v7__HMSemilepSKIMv7_1_data__HMFull_V12_jhchoi_data"
...
muWP='cut_Tight_HWWW'
##---Btag
btagSFSource = '%s/src/PhysicsTools/NanoAODTools/data/btagSF/DeepCSV_102XSF_V2.csv' % os.getenv('CMSSW_BASE')
bAlgo='DeepB'
bWP='0.1241'
...
##---SF & Weight to use
SFweight='puWeight*trigWeight[0]*EMTFbug_veto*LepWPCut[0]*LepWPweight[0]*btagSF*PUJetIdSF'
